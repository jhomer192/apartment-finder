...
async function rank(
  ...
  const prompt = [
    'You are the search interface for a group of five roommates hunting for a San',
    'Francisco rental. Answer their request using only the candidate listings below,',
